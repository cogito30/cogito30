...
<main>
  ...
  <article id="intro">
    <h2>Introduce</h2>
    <div>
      <p>호기심이 많은 엔지니어를 목표로 하고 있습니다..</p>
      <p>무엇이든 불편한 점이 있다면 이를 개선하기 위해 고민하고 시도하는 것을 선호합니다.</p>
      <p>현재 관심사: 네트워크 + 웹 + AI </p>
    </div>
  </article>
  ...
  <article id="certificate">
    ...
    <div>
      <h2>어학</h2>
      <ul>
        <li>TOEIC: 730(2026.01.11)</li>
        <li>TOEIC Speaking: 140(2024.07.28)</li>
      </ul>
      <h2>국가기술</h2>
      <ul>
